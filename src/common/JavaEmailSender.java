...
public class JavaEmailSender {
    ...
    final String USER_NAME = "carrentalweb@gmail.com";   //User name of the Goole(gmail) account
    final String PASSSWORD = "testParole";  //Password of the Goole(gmail) account
    final String FROM_ADDRESS = "carrentalweb@gmail.com";  //From addresss
    ...
    public static void main(String[] args) {
     ...
     //Sending test email
      email.createAndSendEmail("makarfr@gmail.com", "Test email subject",
